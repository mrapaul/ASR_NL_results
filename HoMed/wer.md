...
- The concrete results (INS, DEL, SUB) of each one of the files of the three datasets are included in the .sys files generated with [SCLITE](https://github.com/usnistgov/SCTK). They can be found in the subfolders of the HoMed folder on the repository page of this website.
